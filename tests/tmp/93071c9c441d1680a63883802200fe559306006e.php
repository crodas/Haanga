...
function haanga_93071c9c441d1680a63883802200fe559306006e($vars, $return=FALSE, $blocks=array())
{
    ...
    $buffer2  = "\n    inner2's new value\n    ";
    $buffer3  = "\n        2.1\n    ";
    $blocks["inner2_1"]  = (isset($blocks["inner2_1"]) ? (strpos($blocks["inner2_1"], "{{block.1b3231655cebb7a1f783eddf27d254ca}}") === FALSE ? $blocks["inner2_1"] : str_replace("{{block.1b3231655cebb7a1f783eddf27d254ca}}", $buffer3, $blocks["inner2_1"])) : $buffer3);
